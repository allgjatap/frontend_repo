...
import { Camera, GraduationCap, PencilSimpleLine } from '@phosphor-icons/react';
...
import { CompanyCardInfo } from '@/pages/Settings/components/CardInfo';
import { useGetMe } from '@/services/Auth';
import { useUpdateProfile } from '@/services/User';
import { getFullName } from '@/utils/getFullName';

const candidateInfo: DynamicFormProps[] = [
  { label: 'First Name', name: 'firstName', type: InputType.INPUT },
  { label: 'Last Name', name: 'lastName', type: InputType.INPUT },
  { label: 'Email', name: 'email', type: InputType.EMAIL, disabled: true },
  { label: 'Username', name: 'username', type: InputType.INPUT },
];
const candidateSkills: DynamicFormProps[] = [{ label: 'Skills', name: 'skills', type: InputType.MULTISELECT }];
  ...
  return (
    <div className='flex flex-col gap-8 p-8'>
      <div className='flex flex-col overflow-hidden rounded-xl border bg-white'>
        <div className='relative flex w-full flex-col border-b pb-[90px]'>
      ...
      <div className='grid grid-cols-2 gap-8'>
        <CompanyCardInfo title='Account Information' inputs={candidateInfo} data={user} onSubmit={updateProfile} />
        <CompanyCardInfo title='Skills' inputs={candidateSkills} data={'Skills'} disabled />
        <CompanyCardInfo
          title='Questions'
